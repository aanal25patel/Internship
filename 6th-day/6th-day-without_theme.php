...
$con = mysqli_connect("localhost", "root", "", "internship_") or die("DATABASE NOT FOUND !!!");
...
if($_POST){
	...
	// $q = mysqli_query($con, "insert into tbl_student (Name, ID, Age, Email, Mobile No, City, College Name, DOB, Field) values('$name','$id','$age','$email','$mobile','$city','$college','$dob','$field')") or die(mysqli_error($con));
